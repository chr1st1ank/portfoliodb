...
function uniroot(
    ...
    let p: number;         // Interpolation step is calculated in the form p/q; division is delayed until the last moment
    let q: number;
    ...
    // If we reached the iteration limit, return the current best approximation
    return b;
}
